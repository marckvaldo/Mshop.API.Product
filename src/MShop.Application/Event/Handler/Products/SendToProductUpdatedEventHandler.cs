...
{
    public class SendToProductUpdateEventHandler : IDomainEventHandler<ProductUpdatedEvent>
    {
        private readonly IMessageProducer _messageProducer;
        private readonly IProductRepository _productRepository;

        public SendToProductUpdateEventHandler(IMessageProducer messageProducer, IProductRepository productRepository)
        {
